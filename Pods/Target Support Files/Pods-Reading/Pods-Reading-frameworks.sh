...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$CONFIGURATION_BUILD_DIR/WDYLibrary/WDYLibrary.framework"
  install_framework "$CONFIGURATION_BUILD_DIR/XYYSegmentControl/XYYSegmentControl.framework"
fi
